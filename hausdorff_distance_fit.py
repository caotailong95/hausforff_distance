...
def read_facepoints_from_file(file_path):
...
points_B = read_facepoints_from_file(file_B)
...
# 保存结果到文件
save_distances_to_file("hausdorff_distance_fit.txt", max_d_H, min_d_H, max_points, min_points, min_dist_A_to_B, min_dist_B_to_A, closest_points_A_to_B, closest_points_B_to_A, points_A, points_B, monitoring_points)
...
def visualize_points(set_A, set_B, monitoring_points):
    ...
    # 设置适合的视角
    # ax.view_init(elev=20, azim=50)  # 设定一个合适的视角来观察图形
