...
def calculate_monitoring_points(points_A, points_B):
    ...
    x_coords = np.linspace(x_min, x_max, 10)[1:-1]  # 获取中间九个x值
...
# 保存结果到文件
save_distances_to_file("hausdorff_distance_step.txt", max_d_H, min_d_H, max_points, min_points, min_dist_A_to_B, min_dist_B_to_A, closest_points_A_to_B, closest_points_B_to_A, points_A, points_B, monitoring_points)
